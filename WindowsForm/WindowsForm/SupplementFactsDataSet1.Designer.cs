...
namespace WindowsForm.SupplementFactsDataSet1TableAdapters {
...
SELECT ID, name, importPrice, salePrice, stock FROM Goods WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsForm.Properties.Settings.Default.SupplementFactsConnectionString;
        }
